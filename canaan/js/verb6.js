...
var binyan = 'hitpael';
var roott = 'קטל';
var meaning = 'to suicide (to kill yourself)';
...
document.getElementById("a4").innerHTML = conjugate(testroot,binyan,'perfect','IIIsgm');
document.getElementById("a1").innerHTML = conjugate(testroot,binyan,'perfect','Isg');
document.getElementById("a2").innerHTML = conjugate(testroot,binyan,'perfect','IIsgm');
document.getElementById("a3").innerHTML = conjugate(testroot,binyan,'perfect','IIsgf');
document.getElementById("a5").innerHTML = conjugate(testroot,binyan,'perfect','IIIsgf');
document.getElementById("a6").innerHTML = conjugate(testroot,binyan,'perfect','Ipl');
document.getElementById("a7").innerHTML = conjugate(testroot,binyan,'perfect','IIplm');
document.getElementById("a8").innerHTML = conjugate(testroot,binyan,'perfect','IIplf');
document.getElementById("a9").innerHTML = conjugate(testroot,binyan,'perfect','IIIplm');
document.getElementById("a10").innerHTML = conjugate(testroot,binyan,'perfect','IIIplf');
document.getElementById("b1").innerHTML = conjugate(testroot,binyan,'imperfect','Isg');
document.getElementById("b2").innerHTML = conjugate(testroot,binyan,'imperfect','IIsgm');
document.getElementById("b3").innerHTML = conjugate(testroot,binyan,'imperfect','IIsgf');
document.getElementById("b4").innerHTML = conjugate(testroot,binyan,'imperfect','IIIsgm');
document.getElementById("b5").innerHTML = conjugate(testroot,binyan,'imperfect','IIIsgf');
document.getElementById("b6").innerHTML = conjugate(testroot,binyan,'imperfect','Ipl');
document.getElementById("b7").innerHTML = conjugate(testroot,binyan,'imperfect','IIplm');
document.getElementById("b8").innerHTML = conjugate(testroot,binyan,'imperfect','IIplf');
document.getElementById("b9").innerHTML = conjugate(testroot,binyan,'imperfect','IIIplm');
document.getElementById("b10").innerHTML = conjugate(testroot,binyan,'imperfect','IIIplf');
document.getElementById("c1").innerHTML = conjugate(testroot,binyan,'imperative','IIsgm');
document.getElementById("c2").innerHTML = conjugate(testroot,binyan,'imperative','IIsgf');
document.getElementById("c3").innerHTML = conjugate(testroot,binyan,'imperative','IIplm');
document.getElementById("c4").innerHTML = conjugate(testroot,binyan,'imperative','IIplf');
document.getElementById("d1").innerHTML = conjugate(testroot,binyan,'participle','mascsg');
document.getElementById("d2").innerHTML = conjugate(testroot,binyan,'participle','femsg');
document.getElementById("d3").innerHTML = conjugate(testroot,binyan,'participle','mascpl');
document.getElementById("d4").innerHTML = conjugate(testroot,binyan,'participle','fempl');
document.getElementById("e1").innerHTML = conjugate(testroot,binyan,'infinitive','absolute');
document.getElementById("e2").innerHTML = conjugate(testroot,binyan,'infinitive','construct');
};
