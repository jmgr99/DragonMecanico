...
document.getElementById("form").innerHTML = 'Hitpael';
document.getElementById("a1").innerHTML = conjugate(testroot,'hitpael','perfect','Isg');
document.getElementById("a2").innerHTML = conjugate(testroot,'hitpael','perfect','IIsgm');
document.getElementById("a3").innerHTML = conjugate(testroot,'hitpael','perfect','IIsgf');
document.getElementById("a4").innerHTML = conjugate(testroot,'hitpael','perfect','IIIsgm');
document.getElementById("a5").innerHTML = conjugate(testroot,'hitpael','perfect','IIIsgf');
document.getElementById("a6").innerHTML = conjugate(testroot,'hitpael','perfect','Ipl');
document.getElementById("a7").innerHTML = conjugate(testroot,'hitpael','perfect','IIplm');
document.getElementById("a8").innerHTML = conjugate(testroot,'hitpael','perfect','IIplf');
document.getElementById("a9").innerHTML = conjugate(testroot,'hitpael','perfect','IIIplm');
document.getElementById("a10").innerHTML = conjugate(testroot,'hitpael','perfect','IIIplf');
document.getElementById("b1").innerHTML = conjugate(testroot,'hitpael','imperfect','Isg');
document.getElementById("b2").innerHTML = conjugate(testroot,'hitpael','imperfect','IIsgm');
document.getElementById("b3").innerHTML = conjugate(testroot,'hitpael','imperfect','IIsgf');
document.getElementById("b4").innerHTML = conjugate(testroot,'hitpael','imperfect','IIIsgm');
document.getElementById("b5").innerHTML = conjugate(testroot,'hitpael','imperfect','IIIsgf');
document.getElementById("b6").innerHTML = conjugate(testroot,'hitpael','imperfect','Ipl');
document.getElementById("b7").innerHTML = conjugate(testroot,'hitpael','imperfect','IIplm');
document.getElementById("b8").innerHTML = conjugate(testroot,'hitpael','imperfect','IIplf');
document.getElementById("b9").innerHTML = conjugate(testroot,'hitpael','imperfect','IIIplm');
document.getElementById("b10").innerHTML = conjugate(testroot,'hitpael','imperfect','IIIplf');
document.getElementById("c1").innerHTML = conjugate(testroot,'hitpael','imperative','IIsgm');
document.getElementById("c2").innerHTML = conjugate(testroot,'hitpael','imperative','IIsgf');
document.getElementById("c3").innerHTML = conjugate(testroot,'hitpael','imperative','IIplm');
document.getElementById("c4").innerHTML = conjugate(testroot,'hitpael','imperative','IIplf');
document.getElementById("d1").innerHTML = conjugate(testroot,'hitpael','participle','mascsg');
document.getElementById("d2").innerHTML = conjugate(testroot,'hitpael','participle','femsg');
document.getElementById("d3").innerHTML = conjugate(testroot,'hitpael','participle','mascpl');
document.getElementById("d4").innerHTML = conjugate(testroot,'hitpael','participle','fempl');
document.getElementById("e1").innerHTML = conjugate(testroot,'hitpael','infinitive','absolute');
document.getElementById("e2").innerHTML = conjugate(testroot,'hitpael','infinitive','construct');
};
