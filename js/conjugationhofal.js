...
document.getElementById("form").innerHTML = 'Hofal';
document.getElementById("a1").innerHTML = conjugate(testroot,'hofal','perfect','Isg');
document.getElementById("a2").innerHTML = conjugate(testroot,'hofal','perfect','IIsgm');
document.getElementById("a3").innerHTML = conjugate(testroot,'hofal','perfect','IIsgf');
document.getElementById("a4").innerHTML = conjugate(testroot,'hofal','perfect','IIIsgm');
document.getElementById("a5").innerHTML = conjugate(testroot,'hofal','perfect','IIIsgf');
document.getElementById("a6").innerHTML = conjugate(testroot,'hofal','perfect','Ipl');
document.getElementById("a7").innerHTML = conjugate(testroot,'hofal','perfect','IIplm');
document.getElementById("a8").innerHTML = conjugate(testroot,'hofal','perfect','IIplf');
document.getElementById("a9").innerHTML = conjugate(testroot,'hofal','perfect','IIIplm');
document.getElementById("a10").innerHTML = conjugate(testroot,'hofal','perfect','IIIplf');
document.getElementById("b1").innerHTML = conjugate(testroot,'hofal','imperfect','Isg');
document.getElementById("b2").innerHTML = conjugate(testroot,'hofal','imperfect','IIsgm');
document.getElementById("b3").innerHTML = conjugate(testroot,'hofal','imperfect','IIsgf');
document.getElementById("b4").innerHTML = conjugate(testroot,'hofal','imperfect','IIIsgm');
document.getElementById("b5").innerHTML = conjugate(testroot,'hofal','imperfect','IIIsgf');
document.getElementById("b6").innerHTML = conjugate(testroot,'hofal','imperfect','Ipl');
document.getElementById("b7").innerHTML = conjugate(testroot,'hofal','imperfect','IIplm');
document.getElementById("b8").innerHTML = conjugate(testroot,'hofal','imperfect','IIplf');
document.getElementById("b9").innerHTML = conjugate(testroot,'hofal','imperfect','IIIplm');
document.getElementById("b10").innerHTML = conjugate(testroot,'hofal','imperfect','IIIplf');
document.getElementById("d1").innerHTML = conjugate(testroot,'hofal','participle','mascsg');
document.getElementById("d2").innerHTML = conjugate(testroot,'hofal','participle','femsg');
document.getElementById("d3").innerHTML = conjugate(testroot,'hofal','participle','mascpl');
document.getElementById("d4").innerHTML = conjugate(testroot,'hofal','participle','fempl');
document.getElementById("e1").innerHTML = conjugate(testroot,'hofal','infinitive','absolute');
};
