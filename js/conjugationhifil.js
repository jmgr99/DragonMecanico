...
document.getElementById("form").innerHTML = 'Hifil';
document.getElementById("a1").innerHTML = conjugate(testroot,'hifil','perfect','Isg');
document.getElementById("a2").innerHTML = conjugate(testroot,'hifil','perfect','IIsgm');
document.getElementById("a3").innerHTML = conjugate(testroot,'hifil','perfect','IIsgf');
document.getElementById("a4").innerHTML = conjugate(testroot,'hifil','perfect','IIIsgm');
document.getElementById("a5").innerHTML = conjugate(testroot,'hifil','perfect','IIIsgf');
document.getElementById("a6").innerHTML = conjugate(testroot,'hifil','perfect','Ipl');
document.getElementById("a7").innerHTML = conjugate(testroot,'hifil','perfect','IIplm');
document.getElementById("a8").innerHTML = conjugate(testroot,'hifil','perfect','IIplf');
document.getElementById("a9").innerHTML = conjugate(testroot,'hifil','perfect','IIIplm');
document.getElementById("a10").innerHTML = conjugate(testroot,'hifil','perfect','IIIplf');
document.getElementById("b1").innerHTML = conjugate(testroot,'hifil','imperfect','Isg');
document.getElementById("b2").innerHTML = conjugate(testroot,'hifil','imperfect','IIsgm');
document.getElementById("b3").innerHTML = conjugate(testroot,'hifil','imperfect','IIsgf');
document.getElementById("b4").innerHTML = conjugate(testroot,'hifil','imperfect','IIIsgm');
document.getElementById("b5").innerHTML = conjugate(testroot,'hifil','imperfect','IIIsgf');
document.getElementById("b6").innerHTML = conjugate(testroot,'hifil','imperfect','Ipl');
document.getElementById("b7").innerHTML = conjugate(testroot,'hifil','imperfect','IIplm');
document.getElementById("b8").innerHTML = conjugate(testroot,'hifil','imperfect','IIplf');
document.getElementById("b9").innerHTML = conjugate(testroot,'hifil','imperfect','IIIplm');
document.getElementById("b10").innerHTML = conjugate(testroot,'hifil','imperfect','IIIplf');
document.getElementById("c1").innerHTML = conjugate(testroot,'hifil','imperative','IIsgm');
document.getElementById("c2").innerHTML = conjugate(testroot,'hifil','imperative','IIsgf');
document.getElementById("c3").innerHTML = conjugate(testroot,'hifil','imperative','IIplm');
document.getElementById("c4").innerHTML = conjugate(testroot,'hifil','imperative','IIplf');
document.getElementById("d1").innerHTML = conjugate(testroot,'hifil','participle','mascsg');
document.getElementById("d2").innerHTML = conjugate(testroot,'hifil','participle','femsg');
document.getElementById("d3").innerHTML = conjugate(testroot,'hifil','participle','mascpl');
document.getElementById("d4").innerHTML = conjugate(testroot,'hifil','participle','fempl');
document.getElementById("e1").innerHTML = conjugate(testroot,'hifil','infinitive','absolute');
document.getElementById("e2").innerHTML = conjugate(testroot,'hifil','infinitive','construct');
};
