...
document.getElementById("form").innerHTML = 'Nifal';
document.getElementById("a1").innerHTML = conjugate(testroot,'nifal','perfect','Isg');
document.getElementById("a2").innerHTML = conjugate(testroot,'nifal','perfect','IIsgm');
document.getElementById("a3").innerHTML = conjugate(testroot,'nifal','perfect','IIsgf');
document.getElementById("a4").innerHTML = conjugate(testroot,'nifal','perfect','IIIsgm');
document.getElementById("a5").innerHTML = conjugate(testroot,'nifal','perfect','IIIsgf');
document.getElementById("a6").innerHTML = conjugate(testroot,'nifal','perfect','Ipl');
document.getElementById("a7").innerHTML = conjugate(testroot,'nifal','perfect','IIplm');
document.getElementById("a8").innerHTML = conjugate(testroot,'nifal','perfect','IIplf');
document.getElementById("a9").innerHTML = conjugate(testroot,'nifal','perfect','IIIplm');
document.getElementById("a10").innerHTML = conjugate(testroot,'nifal','perfect','IIIplf');
document.getElementById("b1").innerHTML = conjugate(testroot,'nifal','imperfect','Isg');
document.getElementById("b2").innerHTML = conjugate(testroot,'nifal','imperfect','IIsgm');
document.getElementById("b3").innerHTML = conjugate(testroot,'nifal','imperfect','IIsgf');
document.getElementById("b4").innerHTML = conjugate(testroot,'nifal','imperfect','IIIsgm');
document.getElementById("b5").innerHTML = conjugate(testroot,'nifal','imperfect','IIIsgf');
document.getElementById("b6").innerHTML = conjugate(testroot,'nifal','imperfect','Ipl');
document.getElementById("b7").innerHTML = conjugate(testroot,'nifal','imperfect','IIplm');
document.getElementById("b8").innerHTML = conjugate(testroot,'nifal','imperfect','IIplf');
document.getElementById("b9").innerHTML = conjugate(testroot,'nifal','imperfect','IIIplm');
document.getElementById("b10").innerHTML = conjugate(testroot,'nifal','imperfect','IIIplf');
document.getElementById("c1").innerHTML = conjugate(testroot,'nifal','imperative','IIsgm');
document.getElementById("c2").innerHTML = conjugate(testroot,'nifal','imperative','IIsgf');
document.getElementById("c3").innerHTML = conjugate(testroot,'nifal','imperative','IIplm');
document.getElementById("c4").innerHTML = conjugate(testroot,'nifal','imperative','IIplf');
document.getElementById("d1").innerHTML = conjugate(testroot,'nifal','participle','mascsg');
document.getElementById("d2").innerHTML = conjugate(testroot,'nifal','participle','femsg');
document.getElementById("d3").innerHTML = conjugate(testroot,'nifal','participle','mascpl');
document.getElementById("d4").innerHTML = conjugate(testroot,'nifal','participle','fempl');
document.getElementById("e1").innerHTML = conjugate(testroot,'nifal','infinitive','absolute');
document.getElementById("e2").innerHTML = conjugate(testroot,'nifal','infinitive','construct');
};
