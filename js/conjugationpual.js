...
document.getElementById("form").innerHTML = 'Pual';
document.getElementById("a1").innerHTML = conjugate(testroot,'pual','perfect','Isg');
document.getElementById("a2").innerHTML = conjugate(testroot,'pual','perfect','IIsgm');
document.getElementById("a3").innerHTML = conjugate(testroot,'pual','perfect','IIsgf');
document.getElementById("a4").innerHTML = conjugate(testroot,'pual','perfect','IIIsgm');
document.getElementById("a5").innerHTML = conjugate(testroot,'pual','perfect','IIIsgf');
document.getElementById("a6").innerHTML = conjugate(testroot,'pual','perfect','Ipl');
document.getElementById("a7").innerHTML = conjugate(testroot,'pual','perfect','IIplm');
document.getElementById("a8").innerHTML = conjugate(testroot,'pual','perfect','IIplf');
document.getElementById("a9").innerHTML = conjugate(testroot,'pual','perfect','IIIplm');
document.getElementById("a10").innerHTML = conjugate(testroot,'pual','perfect','IIIplf');
document.getElementById("b1").innerHTML = conjugate(testroot,'pual','imperfect','Isg');
document.getElementById("b2").innerHTML = conjugate(testroot,'pual','imperfect','IIsgm');
document.getElementById("b3").innerHTML = conjugate(testroot,'pual','imperfect','IIsgf');
document.getElementById("b4").innerHTML = conjugate(testroot,'pual','imperfect','IIIsgm');
document.getElementById("b5").innerHTML = conjugate(testroot,'pual','imperfect','IIIsgf');
document.getElementById("b6").innerHTML = conjugate(testroot,'pual','imperfect','Ipl');
document.getElementById("b7").innerHTML = conjugate(testroot,'pual','imperfect','IIplm');
document.getElementById("b8").innerHTML = conjugate(testroot,'pual','imperfect','IIplf');
document.getElementById("b9").innerHTML = conjugate(testroot,'pual','imperfect','IIIplm');
document.getElementById("b10").innerHTML = conjugate(testroot,'pual','imperfect','IIIplf');
document.getElementById("d1").innerHTML = conjugate(testroot,'pual','participle','mascsg');
document.getElementById("d2").innerHTML = conjugate(testroot,'pual','participle','femsg');
document.getElementById("d3").innerHTML = conjugate(testroot,'pual','participle','mascpl');
document.getElementById("d4").innerHTML = conjugate(testroot,'pual','participle','fempl');
document.getElementById("e1").innerHTML = conjugate(testroot,'pual','infinitive','absolute');
};
