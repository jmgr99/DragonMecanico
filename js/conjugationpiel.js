...
document.getElementById("form").innerHTML = 'Piel';
document.getElementById("a1").innerHTML = conjugate(testroot,'piel','perfect','Isg');
document.getElementById("a2").innerHTML = conjugate(testroot,'piel','perfect','IIsgm');
document.getElementById("a3").innerHTML = conjugate(testroot,'piel','perfect','IIsgf');
document.getElementById("a4").innerHTML = conjugate(testroot,'piel','perfect','IIIsgm');
document.getElementById("a5").innerHTML = conjugate(testroot,'piel','perfect','IIIsgf');
document.getElementById("a6").innerHTML = conjugate(testroot,'piel','perfect','Ipl');
document.getElementById("a7").innerHTML = conjugate(testroot,'piel','perfect','IIplm');
document.getElementById("a8").innerHTML = conjugate(testroot,'piel','perfect','IIplf');
document.getElementById("a9").innerHTML = conjugate(testroot,'piel','perfect','IIIplm');
document.getElementById("a10").innerHTML = conjugate(testroot,'piel','perfect','IIIplf');
document.getElementById("b1").innerHTML = conjugate(testroot,'piel','imperfect','Isg');
document.getElementById("b2").innerHTML = conjugate(testroot,'piel','imperfect','IIsgm');
document.getElementById("b3").innerHTML = conjugate(testroot,'piel','imperfect','IIsgf');
document.getElementById("b4").innerHTML = conjugate(testroot,'piel','imperfect','IIIsgm');
document.getElementById("b5").innerHTML = conjugate(testroot,'piel','imperfect','IIIsgf');
document.getElementById("b6").innerHTML = conjugate(testroot,'piel','imperfect','Ipl');
document.getElementById("b7").innerHTML = conjugate(testroot,'piel','imperfect','IIplm');
document.getElementById("b8").innerHTML = conjugate(testroot,'piel','imperfect','IIplf');
document.getElementById("b9").innerHTML = conjugate(testroot,'piel','imperfect','IIIplm');
document.getElementById("b10").innerHTML = conjugate(testroot,'piel','imperfect','IIIplf');
document.getElementById("c1").innerHTML = conjugate(testroot,'piel','imperative','IIsgm');
document.getElementById("c2").innerHTML = conjugate(testroot,'piel','imperative','IIsgf');
document.getElementById("c3").innerHTML = conjugate(testroot,'piel','imperative','IIplm');
document.getElementById("c4").innerHTML = conjugate(testroot,'piel','imperative','IIplf');
document.getElementById("d1").innerHTML = conjugate(testroot,'piel','participle','mascsg');
document.getElementById("d2").innerHTML = conjugate(testroot,'piel','participle','femsg');
document.getElementById("d3").innerHTML = conjugate(testroot,'piel','participle','mascpl');
document.getElementById("d4").innerHTML = conjugate(testroot,'piel','participle','fempl');
document.getElementById("e1").innerHTML = conjugate(testroot,'piel','infinitive','absolute');
document.getElementById("e2").innerHTML = conjugate(testroot,'piel','infinitive','construct');
};
